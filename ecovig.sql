...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-08-2024 a las 00:23:23
...
CREATE TABLE `climas` (
  ...
  `tipo_de_climas` varchar(50) NOT NULL,
  `descripcón` varchar(500) NOT NULL
...
INSERT INTO `climas` (`id_climas`, `tipo_de_climas`, `descripcón`) VALUES
(1, 'Aumento de las temperaturas', 'En Formosa, el aumento de las temperaturas incrementa la evaporación del agua del suelo, lo que puede llevar a una mayor sequedad y aumentar la demanda de riego. Las plantas experimentan estrés térmico cuando las temperaturas exceden su rango óptimo de crecimiento, reduciendo la fotosíntesis y el crecimiento. Además, algunas regiones pueden volverse demasiado cálidas para ciertos cultivos tradicionales, obligando a los agricultores a cambiar a cultivos más tolerantes al calor, lo que afecta la p'),
(2, 'Cambio en los patrones de precipitación', 'En Formosa, los cambios en los patrones de precipitación incluyen periodos de sequía más prolongados y lluvias más intensas y repentinas. Las sequías reducen la disponibilidad de agua para el riego, afectando negativamente el crecimiento de los cultivos y disminuyendo los rendimientos. Por otro lado, las lluvias intensas pueden causar inundaciones, erosionar el suelo y dañar las raíces de las plantas. La variabilidad interanual en las lluvias dificulta la planificación agrícola, aumentando el ri'),
(3, 'Eventos climáticos extremos', 'En Formosa, los eventos climáticos extremos, como tormentas severas, granizo y vientos fuertes, pueden causar daños físicos significativos a los cultivos. Estas condiciones pueden destrozar plantas, destruir infraestructura agrícola y reducir los rendimientos. Además, las tormentas pueden provocar inundaciones y deslizamientos de tierra, afectando la salud del suelo y la disponibilidad de nutrientes para los cultivos. La frecuencia y la intensidad de estos eventos extremos están aumentando debid'),
(4, 'Proliferación de plagas y enfermedade', 'En Formosa, el cambio climático, con temperaturas más altas y mayor humedad, favorece la proliferación de plagas y enfermedades que afectan a los cultivos. Las plagas pueden multiplicarse más rápidamente y expandir su rango geográfico, mientras que las enfermedades pueden encontrar condiciones más favorables para su desarrollo. Esto aumenta la necesidad de pesticidas y otras medidas de control, elevando los costos de producción y reduciendo la rentabilidad agrícola. La resistencia a los tratamie'),
(5, 'Desertificación y degradación del suelo', 'En Formosa, la desertificación y la degradación del suelo son problemas agravados por el cambio climático, afectando la fertilidad y la capacidad productiva de la tierra. La pérdida de materia orgánica y nutrientes del suelo reduce su capacidad para retener agua y soportar el crecimiento de las plantas. La erosión del suelo, exacerbada por lluvias intensas y vientos fuertes, elimina la capa superior fértil, dejando un terreno menos productivo. Estos procesos pueden llevar a una disminución en lo'),
(6, 'Aumento de las temperaturas', 'En Buenos Aires, el aumento de las temperaturas está generando un incremento en la evaporación del agua del suelo, intensificando la sequedad y la necesidad de riego para los cultivos. El calor extremo puede causar estrés térmico en cultivos como el trigo y la soja, reduciendo su rendimiento y crecimiento. Además, las temperaturas elevadas pueden forzar a los agricultores a cambiar a variedades de cultivos más resistentes al calor, afectando la distribución y producción de cultivos predominantes'),
(7, 'Cambio en los patrones de precipitación', 'En Buenos Aires, los cambios en los patrones de precipitación se manifiestan en sequías prolongadas y lluvias intensas. Las sequías pueden reducir la disponibilidad de agua para riego, afectando negativamente la producción de cultivos como la soja y el maíz, que son sensibles a la falta de humedad. Por otro lado, las lluvias intensas pueden provocar inundaciones y erosión del suelo, dañando las raíces y reduciendo la capacidad de los cultivos para prosperar. Esta variabilidad en la precipitación'),
(8, 'Eventos climáticos extremos', 'En Buenos Aires, los eventos climáticos extremos como tormentas severas, granizo y vientos fuertes están impactando negativamente la agricultura. Estas tormentas pueden causar daños severos en los cultivos, destruir infraestructura agrícola y reducir significativamente los rendimientos. Las lluvias torrenciales pueden llevar a inundaciones que erosionan el suelo y afectan la salud de las plantas, aumentando la vulnerabilidad de los agricultores ante estos fenómenos cada vez más frecuentes e inte'),
(9, 'Proliferación de plagas y enfermedade', 'En Buenos Aires, el cambio climático está creando condiciones más favorables para la proliferación de plagas y enfermedades. El aumento de la temperatura y la humedad facilita el desarrollo de insectos dañinos como los trips y enfermedades como el oídio en cultivos de soja y maíz. Esto resulta en una mayor necesidad de pesticidas y medidas de control, elevando los costos de producción y afectando la rentabilidad. La resistencia a los tratamientos también se está convirtiendo en un desafío crecie'),
(10, 'Desertificación y degradación del suelo', 'En Buenos Aires, la desertificación y la degradación del suelo son problemas crecientes impulsados por el cambio climático. La reducción de la materia orgánica y nutrientes en el suelo, combinada con la erosión causada por lluvias intensas y la pérdida de cobertura vegetal, disminuye la capacidad del suelo para retener agua y sustentar cultivos. Estos procesos llevan a una menor productividad agrícola y a la necesidad de adoptar prácticas de manejo sostenible para restaurar la fertilidad del sue'),
(11, 'Aumento de las temperaturas', 'En Tierra del Fuego, el aumento de las temperaturas está provocando un deshielo acelerado en los glaciares y un incremento en la evaporación del agua en el suelo. Este calentamiento puede reducir la disponibilidad de agua para riego y afectar los ecosistemas agrícolas. Las plantas y cultivos que prosperan en climas más fríos pueden experimentar estrés térmico, lo que reduce su rendimiento. Además, el cambio en las temperaturas puede alterar los ciclos de cultivo tradicionales y forzar a los agri'),
(12, 'Cambio en los patrones de precipitación', 'En Tierra del Fuego, los patrones de precipitación están cambiando, con un aumento en las lluvias durante ciertos períodos y sequías en otros. Las lluvias intensas pueden provocar inundaciones y erosionar el suelo, afectando negativamente el crecimiento de los cultivos y la estabilidad del terreno agrícola. En contraste, las sequías pueden reducir la disponibilidad de agua, lo que puede poner en riesgo la producción de cultivos que dependen de un suministro constante de humedad. Esta variabilida'),
(13, 'Eventos climáticos extremos', 'En Tierra del Fuego, los eventos climáticos extremos, como tormentas severas, vientos fuertes y granizo, están afectando la agricultura de manera significativa. Las tormentas pueden causar daños severos en los cultivos, así como en la infraestructura agrícola. Los vientos fuertes pueden erosionar el suelo y afectar el crecimiento de las plantas, mientras que el granizo puede destruir los cultivos en su etapa de desarrollo. La frecuencia e intensidad de estos eventos están aumentando, poniendo en'),
(14, 'Proliferación de plagas y enfermedades', 'En Tierra del Fuego, el cambio climático está creando condiciones más favorables para la proliferación de plagas y enfermedades que afectan a los cultivos. El calentamiento y la mayor humedad pueden facilitar el desarrollo y expansión de insectos y patógenos que antes no eran comunes en la región. Esto puede aumentar la necesidad de tratamientos fitosanitarios y elevar los costos de producción, además de reducir la rentabilidad de los cultivos. La adaptación a estos nuevos desafíos puede requeri'),
(15, 'Desertificación y degradación del suelo', 'En Tierra del Fuego, la desertificación y la degradación del suelo están emergiendo como preocupaciones significativas debido al cambio climático. La pérdida de vegetación y la erosión causada por eventos climáticos extremos pueden reducir la capacidad del suelo para retener agua y sostener los cultivos. La reducción en la materia orgánica y nutrientes del suelo afecta su fertilidad y productividad. La región puede necesitar adoptar prácticas de manejo sostenible para mitigar estos efectos y rec'),
(16, 'Aumento de las temperaturas', 'En Córdoba, el aumento de las temperaturas está generando un incremento en la evaporación del agua del suelo, lo que puede intensificar la sequedad y la demanda de riego para los cultivos. Las olas de calor y las temperaturas elevadas pueden provocar estrés térmico en cultivos importantes como el maíz y la soja, reduciendo su crecimiento y rendimiento. Este calentamiento puede también obligar a los agricultores a adaptar sus prácticas y seleccionar variedades más resistentes al calor, afectando '),
(17, 'Cambio en los patrones de precipitación', 'En Córdoba, los cambios en los patrones de precipitación se reflejan en una mayor variabilidad, con periodos de sequía más prolongados y lluvias intensas y erráticas. Las sequías pueden reducir la disponibilidad de agua para riego, afectando negativamente la producción de cultivos como la soja y el trigo, que son sensibles a la falta de humedad. Por otro lado, las lluvias intensas pueden causar inundaciones y erosión del suelo, dañando las raíces y reduciendo la capacidad de los cultivos para pr'),
(18, 'Eventos climáticos extremos', 'En Córdoba, los eventos climáticos extremos, como tormentas severas, granizo y vientos fuertes, están impactando la agricultura de manera significativa. Las tormentas pueden causar daños severos en los cultivos y en la infraestructura agrícola, mientras que el granizo puede destruir los cultivos en su etapa de desarrollo. Los vientos fuertes pueden erosionar el suelo y afectar el crecimiento de las plantas. La creciente frecuencia e intensidad de estos eventos extremos representan un desafío cre'),
(19, 'Proliferación de plagas y enfermedades', 'En Córdoba, el cambio climático está creando condiciones más favorables para la proliferación de plagas y enfermedades. El aumento de las temperaturas y la mayor humedad facilitan el desarrollo de insectos dañinos como los pulgones y enfermedades como el mildiu en cultivos como la soja y el maíz. Esto puede llevar a una mayor necesidad de pesticidas y medidas de control, elevando los costos de producción y reduciendo la rentabilidad. La resistencia a los tratamientos también está emergiendo como'),
(20, 'Desertificación y degradación del suelo', 'En Córdoba, la desertificación y la degradación del suelo son problemas crecientes exacerbados por el cambio climático. La pérdida de vegetación y la erosión del suelo, agravadas por lluvias intensas y vientos fuertes, disminuyen la capacidad del suelo para retener agua y soportar cultivos. La reducción de la materia orgánica y nutrientes del suelo afecta su fertilidad y productividad. La región puede necesitar adoptar prácticas de manejo sostenible para restaurar la salud del suelo y prevenir u'),
(21, 'Aumento de las temperaturas', 'En Santiago del Estero, el aumento de las temperaturas está provocando un incremento en la evaporación del agua del suelo, lo que intensifica la sequedad y la demanda de riego para los cultivos. Las temperaturas elevadas pueden causar estrés térmico en cultivos como el maíz y la soja, reduciendo su rendimiento y crecimiento. Además, el calor extremo puede alterar los ciclos de cultivo tradicionales, obligando a los agricultores a adoptar variedades más resistentes al calor y ajustar sus práctica'),
(22, 'Cambio en los patrones de precipitación', 'En Santiago del Estero, los patrones de precipitación están experimentando una mayor variabilidad, con sequías más prolongadas y lluvias intensas y erráticas. Las sequías pueden reducir significativamente la disponibilidad de agua para el riego, afectando negativamente la producción de cultivos sensibles a la humedad. Las lluvias intensas pueden provocar inundaciones y erosión del suelo, dañando las raíces y reduciendo la capacidad de los cultivos para prosperar. Esta variabilidad en la precipit'),
(23, 'Eventos climáticos extremos', 'En Santiago del Estero, los eventos climáticos extremos, como tormentas severas, granizo y vientos fuertes, están afectando gravemente la agricultura. Las tormentas pueden causar daños severos a los cultivos y destruir la infraestructura agrícola. El granizo puede impactar negativamente en la fase de desarrollo de los cultivos, mientras que los vientos fuertes pueden erosionar el suelo y dañar las plantas. La creciente frecuencia e intensidad de estos eventos extremos aumenta el riesgo y la vuln'),
(24, 'Proliferación de plagas y enfermedades', 'En Santiago del Estero, el cambio climático está creando condiciones más favorables para la proliferación de plagas y enfermedades. El aumento de la temperatura y la mayor humedad favorecen el desarrollo de insectos dañinos como los trips y enfermedades como el mildiu en cultivos como el maíz y la soja. Esto puede resultar en una mayor necesidad de tratamientos fitosanitarios, elevando los costos de producción y afectando la rentabilidad agrícola. Además, la resistencia a los pesticidas puede vo'),
(25, 'Desertificación y degradación del suelo', 'En Santiago del Estero, la desertificación y la degradación del suelo son problemas crecientes exacerbados por el cambio climático. La pérdida de vegetación y la erosión del suelo, agravadas por las sequías y las lluvias intensas, disminuyen la capacidad del suelo para retener agua y mantener su fertilidad. La reducción de materia orgánica y nutrientes del suelo afecta su capacidad para soportar cultivos, llevando a una menor productividad agrícola. Adoptar prácticas de manejo sostenible es cruc');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `climas_por_provincia`
--

CREATE TABLE `climas_por_provincia` (
  `id_clima_por_provincia` int(11) NOT NULL,
  `id_provincia` int(11) NOT NULL,
  `id_climas` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `climas_por_provincia`
--

INSERT INTO `climas_por_provincia` (`id_clima_por_provincia`, `id_provincia`, `id_climas`) VALUES
(1, 1826, 1),
(2, 1826, 2),
(3, 1826, 3),
(4, 1826, 4),
...
INSERT INTO `usuarios` (`id_user`, `Nombre_Apellido`, `Email`, `Fecha_Nacimiento`, `id_pais`, `id_provincia`, `contraseña`, `imagen`) VALUES
(1, 'Da Silva Felix Bruno', 'brunolok79@gmail.com', '2004-04-12', 5, 1826, '$2b$10$c/EWTf.p2P5QqtQ93oGaJeWkNNZRZva.fDVZ2QLaxJSoy9zseM/7a', NULL);
...
--
-- Indices de la tabla `climas_por_provincia`
--
ALTER TABLE `climas_por_provincia`
  ADD PRIMARY KEY (`id_clima_por_provincia`),
  ADD KEY `id_provincia` (`id_provincia`),
  ADD KEY `id_clima` (`id_climas`);
...
--
ALTER TABLE `climas`
  MODIFY `id_climas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `climas_por_provincia`
--
ALTER TABLE `climas_por_provincia`
  MODIFY `id_clima_por_provincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `provincias`
  MODIFY `id_provincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2204;
...
--
-- Filtros para la tabla `climas_por_provincia`
--
ALTER TABLE `climas_por_provincia`
  ADD CONSTRAINT `id_clima` FOREIGN KEY (`id_climas`) REFERENCES `climas` (`id_climas`),
...
--
ALTER TABLE `provincias`
  ADD CONSTRAINT `id_pais` FOREIGN KEY (`id_pais`) REFERENCES `paises` (`id_pais`);
COMMIT;
